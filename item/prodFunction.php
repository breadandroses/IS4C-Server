    ...
    if($num == 0 || !$num){
		...
		/**
			...
			**/
				...
				**/
		echo"</td></tr><tr><th>Taxable</th><th>FS</th><th>Scale</th><th>QtyFrc</th><th>NoDisc</th><th>InUse</th>";
		echo "</tr>";
		echo "<tr>";
		echo "<td align='center'><input type='checkbox' value='0' name='tax'";
        ...
        echo "<th>Dept & SubDept</th><th>Taxable</th><th>FS</th><th>Scale</th><th>QtyFrc</th><th>NoDisc</th><th>In Use</th>";
        echo "</tr>";
        echo "<tr align=top>";
    	echo "<td align=left>";	
	   /**
		...
		**/
			...
			**/
//                echo " </td>";
		echo "</td><td align='center'><input type='checkbox' value='1' name='tax'";
			if($rowItem["tax"] == 1){
				echo " checked";
			}
                echo "></td><td align=center><input type=checkbox value=1 name=FS";
...
//						echo "</td><td>$likeCodeRow[2]</td><td><a href=./testSales.php?upc=$upc target=blank>Click for History</a></tr>";
                ...
                echo "</td></tr><tr><td>&nbsp;</td><td colspan='2' align='right'>$<input type='text'";
 					if (!isset($rowItem[28]) || $rowItem[28] == 0) {
						echo "value='0'";
					} else {
						echo "value='$rowItem[28]'"; 
					}
